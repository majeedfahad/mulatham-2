...
<div class="container py-4">
    ...
    <div class="text-center mb-4 animate-fade-in">
        <img src="{{ asset('imgs/logo-nightsky.svg') }}" alt="ملثم" class="game-logo mb-3" style="width: 140px; height: 140px;">
                    ...
                    <form action="{{ route('game.create') }}" method="POST" id="createForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                type="text"
                                name="name"
                                class="game-input player-name-input"
                    ...
                    <form action="{{ route('game.join') }}" method="POST" id="joinForm" style="display: none;">
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                type="text"
                                name="code"
                                class="game-input room-code-input"
            ...
            <div class="how-to-play-grid">
                ...
                <div class="how-to-play-item">
                    ...
                    <div class="step-content">
                        ...
                        <p class="text-muted-custom small mb-0">أجب على الأسئلة وراقب إجابات الآخرين بأسمائهم المستعارة</p>
                    </div>
                </div>
                <div class="how-to-play-item">
